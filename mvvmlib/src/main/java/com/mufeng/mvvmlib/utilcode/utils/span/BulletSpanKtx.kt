...
class BulletSpanKtx : LeadingMarginSpan {
    ...
    /**
     * Creates a [BulletSpanKtx] with the default values.
     */
    constructor() : this(STANDARD_GAP_WIDTH, STANDARD_COLOR, false, STANDARD_BULLET_RADIUS) {}

    /**
     * Creates a [BulletSpanKtx] based on a gap width
     *
    ...
    /**
     * Creates a [BulletSpanKtx] based on a gap width and a color integer.
     *
     * @param gapWidth the distance, in pixels, between the bullet point and the paragraph.
    ...
    /**
     * Creates a [BulletSpanKtx] from a parcel.
     */
